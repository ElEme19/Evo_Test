        ...
        <div class="col-lg-10 col-xl-8">
            ...
            @if (auth()->user()->rol == 0)
                <div class="text-center mb-3">
                    <a href="{{ route('Precio.create') }}" class="btn btn-outline-success">
                ...
                <div class="d-flex justify-content-center mt-4">
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            ...
                            @else
                                <li class="page-item">
                                    <a class="page-link" href="{{ $precios->previousPageUrl() }}" rel="prev">&laquo;</a>
                                </li>
                            @endif
                            ...
                            @if($precios->hasMorePages())
                                <li class="page-item">
                                    <a class="page-link" href="{{ $precios->nextPageUrl() }}" rel="next">&raquo;</a>
                                </li>
                            @else
                                <li class="page-item disabled">
