            ...
            @endif
             ...
             @if (auth()->user()->rol == 0)
                            <div class="text-center mb-3">
                                <a href="{{ route('Lote.crear') }}" class="btn btn-outline-success">
                        ...
                        <table class="table table-hover mb-0" id="tablaTipoStock">
                            ...
                            <tbody>
                                @forelse ($lotes as $lote)
                                    <tr>
                                        <td class="text-center fw-semibold">{{ $lote->id_lote }}</td>
                                        <td class="text-center fw-semibold">{{ \Carbon\Carbon::parse($lote->fecha_produccion)->format('d-m-Y') }}</td>
            ...
            <div class="d-flex justify-content-between align-items-center mt-3">
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination pagination-sm justify-content-center">
                        ...
                        @else
                            <li class="page-item">
                                <a class="page-link" href="{{ $lotes->previousPageUrl() }}" rel="prev">&laquo;</a>
                            </li>
                        @endif
                        ...
                        @if($lotes->hasMorePages())
                            <li class="page-item">
                                <a class="page-link" href="{{ $lotes->nextPageUrl() }}" rel="next">&raquo;</a>
                            </li>
                        @else
                            <li class="page-item disabled">
