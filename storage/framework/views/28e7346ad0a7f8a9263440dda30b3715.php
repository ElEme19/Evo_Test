        ...
        <div class="col-lg-10 col-xl-8">
            ...
            <div class="text-center my-4">
                <h3 class="d-flex align-items-center justify-content-center">
                    <span class="me-2">Tipos de Lote</span>
            ...
            <div class="d-flex justify-content-center my-3">
                <form class="row g-3 justify-content-center w-100">
                    <div class="col-md-8 position-relative">
                        <input type="text" id="inputBuscar" class="form-control ps-5" placeholder="Buscar por ID o fecha...">
                        ...
                        <table class="table table-hover mb-0" id="tablaTipoStock">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $lotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="text-center fw-semibold"><?php echo e($lote->id_lote); ?></td>
                                        <td class="text-center fw-semibold"><?php echo e(\Carbon\Carbon::parse($lote->fecha_produccion)->format('d-m-Y')); ?></td>
                                        <td class="text-center">
                                            <button type="button" class="btn btn-outline-primary btn-sm" 
                                                data-bs-toggle="modal"
                                                data-bs-target="#modalActualizar<?php echo e($lote->id_lote); ?>">
                                            ...
                                            <?php echo $__env->make('Lote.actualizar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        </td>
                                    </tr>
            ...
            <div class="d-flex justify-content-between align-items-center mt-3">
                <div class="text-muted small">
                    Mostrando <?php echo e($lotes->firstItem()); ?> a <?php echo e($lotes->lastItem()); ?> de <?php echo e($lotes->total()); ?> registros
                </div>
                <nav aria-label="Page navigation">
                    <ul class="pagination pagination-sm justify-content-center">
                        
                        <?php if($lotes->onFirstPage()): ?>
                            <li class="page-item disabled">
                                <span class="page-link">&laquo;</span>
                            </li>
                        <?php else: ?>
                            <li class="page-item">
                                <a class="page-link" href="<?php echo e($lotes->previousPageUrl()); ?>" rel="prev">&laquo;</a>
                            </li>
                        <?php endif; ?>

                        
                        <?php $__currentLoopData = $lotes->getUrlRange(1, $lotes->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($page == $lotes->currentPage()): ?>
                        ...
                        <?php if($lotes->hasMorePages()): ?>
                            <li class="page-item">
                                <a class="page-link" href="<?php echo e($lotes->nextPageUrl()); ?>" rel="next">&raquo;</a>
                            </li>
                        <?php else: ?>
                            <li class="page-item disabled">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\alex2\Escritorio\Repositorios Git\Prueba1\resources\views/Lote/vista.blade.php ENDPATH**/ ?>