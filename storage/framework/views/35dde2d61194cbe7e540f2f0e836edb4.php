...
<?php $__env->startSection('conten'); ?>
    ...
    <form class="row g-3 was-validated" method="POST" action="<?php echo e(route('Envio.store')); ?>">
        <?php echo csrf_field(); ?>
        ...
        <div class="col-md-6">
            ...
            <select class="form-select" id="id_sucursal" name="id_sucursal" required>
                ...
                <?php $__currentLoopData = $sucursales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sucursal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($sucursal->id_sucursal); ?>" <?php echo e(old('id_sucursal') == $sucursal->id_sucursal ? 'selected' : ''); ?>>
        ...
        <div class="col-md-6">
            ...
            <input type="date" class="form-control" id="fecha_envio" name="fecha_envio" value="<?php echo e(old('fecha_envio')); ?>" required>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\alex2\Escritorio\Repositorios Git\Prueba1\resources\views/Envio/crear.blade.php ENDPATH**/ ?>