...
<div class="text-center my-4">
    ...
    <form class="row g-3 justify-content-center">
        <div class="col-md-12">
            <input type="text" id="inputBuscar" class="form-control" placeholder="Buscar color o ID...">
        </div>
    </form>
</div>
...
<table class="table mt-2" id="tablaColores">
  <thead>
    <tr>
  ...
  <tbody>
    ...
    <tr>
      <td><?php echo e($color->id_colorM); ?></td>
      <td><?php echo e($color->id_modelo ?? 'N/A'); ?></td>
      <td><?php echo e($color->nombre_color); ?></td> <!-- O el campo que corresponda al color -->
      <td>
         <button type="button" 
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const tabla = document.getElementById('tablaColores').getElementsByTagName('tbody')[0];

        // Esta función normaliza texto, remueve acentos y lo convierte a minúsculas
