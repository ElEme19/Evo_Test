        ...
        <div class="col-lg-12">
            ...
            <?php if(auth()->user()->rol == 0): ?>
                <div class="text-center mb-3">
                    <a href="<?php echo e(route('Clientes.create')); ?>" class="btn btn-outline-success">
                                    ...
                                    <tr class="text-center">
                                        <td class="align-middle">
                                            <?php if($c->foto_persona): ?>
                                                <img src="<?php echo e(asset('img/clientes/' . $c->foto_persona)); ?>" alt="Foto" width="40" height="40" class="rounded-circle object-fit-cover">
                                            <?php else: ?>
                                        ...
                                        <td class="align-middle fw-semibold"><?php echo e($c->nombre); ?></td>
                                        <td class="align-middle fw-semibold"><?php echo e($c->apellido); ?></td>
                                        <td class="align-middle fw-semibold"><?php echo e($c->telefono); ?></td>
                                        <td class="align-middle fw-semibold"><?php echo e($c->membresia->descripcion_general ?? 'Sin membresía'); ?></td>
                                        <td class="align-middle">
            ...
            <div class="d-flex justify-content-between align-items-center mt-3">
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination pagination-sm justify-content-center">
                        ...
                        <?php if($clientes->onFirstPage()): ?>
                            <li class="page-item disabled">
                                <span class="page-link">&laquo;</span>
                            </li>
                        <?php else: ?>
                            <li class="page-item">
                                <a class="page-link" href="<?php echo e($clientes->previousPageUrl()); ?>" rel="prev">&laquo;</a>
                            </li>
                        <?php endif; ?>

                        
                        <?php $__currentLoopData = $clientes->getUrlRange(1, $clientes->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($page == $clientes->currentPage()): ?>
                        ...
                        <?php if($clientes->hasMorePages()): ?>
                            <li class="page-item">
                                <a class="page-link" href="<?php echo e($clientes->nextPageUrl()); ?>" rel="next">&raquo;</a>
                            </li>
                        <?php else: ?>
                            <li class="page-item disabled">
