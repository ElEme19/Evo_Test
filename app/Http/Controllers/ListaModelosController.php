    ...
    public function index()
{
    ...
    ->leftJoin('voltaje as v', 'b.id_voltaje', '=', 'v.id_voltaje') // Cambiado a LEFT JOIN
    ->where(function($query) {
        $query->whereNull('b.id_pedido')
              ->orWhere('b.id_pedido', '');
    })
    ->selectRaw('m.nombre_modelo, cm.nombre_color, COALESCE(v.tipo_voltaje, "Sin voltaje") as tipo_voltaje, COUNT(*) AS total_disponibles')
    ->groupBy('m.nombre_modelo', 'cm.nombre_color', 'tipo_voltaje')
    ->get();
